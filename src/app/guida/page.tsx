      ...
      <main className="page-wrap space-y-6">
        ...
        <section className="glass-card space-y-3 p-6">
          ...
          <div className="space-y-2 text-sm text-[var(--ink)]">
            <p><strong>1. Eventi:</strong> apri o crea la poll della prossima uscita.</p>
            <p><strong>2. Vota le date:</strong> indica per ogni data se sei disponibile o no.</p>
            <p><strong>3. Finalizzazione:</strong> owner/admin chiude la poll e seleziona la data.</p>
        ...
        <section className="glass-card space-y-3 p-6">
          ...
          <div className="space-y-2 text-sm text-[var(--ink)]">
            ...
            <p><strong>Eventi:</strong> crea/vota poll e consulta lo storico delle serate confermate.</p>
        ...
        <section className="glass-card space-y-3 p-6">
          ...
          <div className="space-y-2 text-sm text-[var(--ink)]">
            <p><strong>Se non ho votato la poll?</strong> Nel dettaglio evento puoi cliccare <strong>Partecipo</strong>.</p>
